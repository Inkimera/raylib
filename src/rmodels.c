...
static Model LoadOBJFromMemory(const char *fileName, const char *fileText);     // Load OBJ mesh data
#endif
...
static Model LoadOBJFromMemory(const char *fileName, const char *fileText)
{
    Model model = { 0 };
